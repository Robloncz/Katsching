...
import { createHistoryTable } from "../graphql/mutations";
...
export default function HistoryTableCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setWicht(initialValues.wicht);
    setVollstrecker(initialValues.vollstrecker);
    setNumKatsching(initialValues.numKatsching);
    setIsCommented(initialValues.isCommented);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createHistoryTable.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "HistoryTableCreateForm")}
      {...rest}
    >
      <TextField
        label="Wicht"
